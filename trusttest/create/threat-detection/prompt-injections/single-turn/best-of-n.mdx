...
- [Role-Playing Exploits](/trusttest/create/threat-detection/prompt-injections/single-turn/role-playing) - Fictional framing attacks
- [System Override](/trusttest/create/threat-detection/prompt-injections/single-turn/system-override) - Instruction override attacks
