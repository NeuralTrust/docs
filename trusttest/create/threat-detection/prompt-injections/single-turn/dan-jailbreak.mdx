...
- [Anti-GPT](/trusttest/create/threat-detection/prompt-injections/single-turn/anti-gpt) - Role reversal attacks
- [Role-Playing Exploits](/trusttest/create/threat-detection/prompt-injections/single-turn/role-playing) - General fictional framing
