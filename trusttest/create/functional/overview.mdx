...
description: Evaluate whether a model still answers correctly, stays on-topic, and meets your criteria.
---

<p className="nt-lead">
  Functional tests check product quality, not security. Use them next to red
  teaming when you need both evidence in one plan.
</p>
