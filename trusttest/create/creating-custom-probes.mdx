...
<CardGroup cols={2}>
  <Card title="AI threat detection" icon="book" href="/trusttest/create/threat-detection/overview">
    Explore the available threat-detection probes and attack categories
  </Card>
