...
For this example we will use the `RepeatTarget` which is a dummy model that will always return the same response the user asks for.
...
- `model`: The LLM model you want to test (in this example we use a `RepeatTarget` for demonstration)
