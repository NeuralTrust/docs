...
Use Crescendo when you want the attacker to escalate toward an objective over several turns. For reinforcement-style steering, use [Echo Chamber](/trusttest/create/threat-detection/prompt-injections/multi-turn/echo-chamber) instead.
