...
from trusttest.catalog import IterateScenario
...
The `IterateScenario` allows you to define specific objectives that the model should either meet or avoid. Here's how to set it up:

```python
scenario = IterateScenario(
