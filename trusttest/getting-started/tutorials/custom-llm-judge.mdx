...
Custom evaluators are useful when built-in judges do not cover your rubric, or when you need a specialized scoring scale. See the [custom evaluator API](/trusttest/evaluate-result/llm-as-a-judge/custom) for both classes.
