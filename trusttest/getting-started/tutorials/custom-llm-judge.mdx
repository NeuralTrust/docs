...
<Note>Custom evaluators are particularly useful when you need to evaluate specific aspects of LLM responses that aren't covered by the built-in evaluators, or when you need a specialized scoring system for your use case.</Note>
