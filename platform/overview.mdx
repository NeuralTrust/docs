---
title: Platform
description: Organization settings shared by TrustGate, TrustGuard, and TrustTest — identity, users, SSO, alerts, and deployment.
---

<p className="nt-lead">
  Platform settings sit above the products: the organization, who can sign in,
  how alerts leave the tenant, and where the control plane and data plane run.
  Open them from the sidebar gear, or from product Settings.
</p>
...
<CardGroup cols={2}>
  ...
  <Card title="Custom Domain" icon="globe" href="/platform/custom-domain">
    Serve the NeuralTrust frontend on a hostname you own, on SaaS or Hybrid.
  </Card>
</CardGroup>
...
8. **[Custom Domain](/platform/custom-domain)** — serve the frontend on your hostname on SaaS or Hybrid.
