...
Platform settings sit above the products. They cover the organization, who can
sign in, how alerts leave the tenant, and where the control plane and data plane
run.

Open **Platform settings** from the sidebar gear, or from product Settings.
