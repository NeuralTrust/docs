...
<CardGroup cols={2}>
  ...
  <Card title="SIEM Integration" icon="database" href="/platform/siem-integration">
...
<CardGroup cols={2}>
  ...
  <Card title="Deployment guides" icon="cloud" href="/neuraltrust/deployment/aws">
...
8. **[SIEM Integration](/platform/siem-integration)** — forward audit events to your security platform.
