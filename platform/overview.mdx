...
Every NeuralTrust tenant is an **organization**. An organization holds your members, roles, SSO configuration, product access, and the products provisioned for you (TrustGate, TrustGuard, TrustTest, Telemetry). **Platform Settings** is the admin surface for everything that lives above the individual products.
...
Org-level hostnames used across products.
