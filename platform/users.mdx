...
| **Employee** | No product at all — their only page is the [Employee portal](/trustgate/mcp/store), where they install the MCP servers they are allowed and connect their own accounts |
