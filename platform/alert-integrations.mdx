...
<Note>
This forwards **alert findings** derived from TrustGuard and TrustGate telemetry. It is separate from [SIEM Integration](/platform/siem-integration), which forwards **audit logs** (authentication, user management, configuration changes). You can use either, both, or neither.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="SIEM Integration (audit logs)" icon="share-2" href="/platform/siem-integration">
