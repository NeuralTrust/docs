...
- **Break the Glass** accounts sign in with **password only** (skip SSO and magic link).
  This is the supported way to grant access to anyone who cannot complete your IdP —
  including an external-domain collaborator (e.g. a guest `@partner.com`) — without
  weakening enforcement for the rest of the organization.
...
account for IdP outages and for any collaborator who cannot authenticate through your
OIDC provider.
</Warning>
