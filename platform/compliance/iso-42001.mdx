...
| **6** | Planning | Partially covered |
| **7** | Support | Partially covered |
| **8** | Operation | Covered |
| **9** | Performance evaluation | Partially covered |
...
Clauses 4, 5, 6, 7, 9 and 10 are partly covered because the rest is
organizational: scoping and stakeholder analysis, writing your AI policy, the risk
criteria and the acceptance decisions behind them, competence records, internal
audit and management review, and the corrective-action process itself. Annex A.8 is
not covered at all.
