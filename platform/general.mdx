...
| Frontend hostname (CNAME) | **Integrations → Custom Domain** | [Custom Domain](/platform/custom-domain) |
...
- Remove client integrations (MDM profiles, PAC URLs, agents)  
...
- **[Custom Domain](/platform/custom-domain)** — frontend hostname on SaaS or Hybrid  
