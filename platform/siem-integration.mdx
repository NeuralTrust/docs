...
<Note>
This page covers forwarding **audit logs** (authentication, user management, configuration changes). To forward **alert findings** derived from TrustGuard and TrustGate telemetry, see [Telemetry → Integrations](/platform/alert-integrations).
</Note>
...
- [Telemetry Integrations](/platform/alert-integrations) — Forward **alert findings** to your SIEM (separate from audit logs)
