...
icon: "/images/integrations/m365.svg"
---
...
<div style={{display:'flex', alignItems:'center', gap:'14px', padding:'16px 20px', borderRadius:'10px', border:'1px solid #e5e7eb', marginBottom:'28px', background:'#fafafa'}}>
  <img src="/images/integrations/m365.svg" style={{width:'40px', height:'40px', flexShrink:0}} />
  <div>
    <p style={{margin:0, fontWeight:'600', fontSize:'15px'}}>Microsoft Copilot Studio</p>
    <p style={{margin:0, fontSize:'13px', color:'#6b7280'}}>Copilot Studio bots · M365 Copilot agents</p>
  </div>
</div>
...
| Graceful degradation | If missing, Agent Posture skips the Agent Registry. Copilot Studio discovery continues unaffected. |
