...
| **Who uses it** | Applications, through routing. | Applications, and people through the Employee portal. |
...
exactly one instance. A built-in server people install themselves from the Employee portal
