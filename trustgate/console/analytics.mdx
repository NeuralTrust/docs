...
| **Cost** | Cost over time and breakdown tables. Sums per-request `cost.total_usd` using [registry contract pricing](/trustgate/concepts/registries#contract-pricing) when set. |
