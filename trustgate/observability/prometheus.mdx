...
This guide outlines how to integrate [TrustGate](https://github.com/NeuralTrust/TrustGate) with Prometheus for metrics scraping and Grafana for observability dashboards.
