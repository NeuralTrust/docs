...
- Console **Playground** — generate a request under a consumer.
- Console **Activity** — request/response/policy detail for past traffic.
- Console **Analytics** — aggregates (volume, cost, policy actions).
