...
On NeuralTrust, those records feed [Activity](/trustgate/console/activity),
[Analytics](/trustgate/console/analytics), and [Telemetry Alerts](/platform/alerts). The
...
| Surface | Use |
|---|---|
| [Activity](/trustgate/console/activity) | Per-request forensics. |
| [Analytics](/trustgate/console/analytics) | Volume, cost, latency, policy actions. |
