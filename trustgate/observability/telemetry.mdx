---
title: "Telemetry"
description: "TrustGate streams a rich per-request event to Kafka — model, tokens, cost, latency breakdown, policy chain, and routing attempts — with optional OTLP export."
---
