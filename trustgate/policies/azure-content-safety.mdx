...
| **Region** | See the warning below. It defaults to **East US**. |
...
<Warning>
**The region defaults to East US, and it decides where your text is analysed.**
Every request makes that round trip, and the text is processed in whichever
region you leave here. For anything with a data-residency constraint this is the
field that matters most on the page, and it is the one most easily left alone.
