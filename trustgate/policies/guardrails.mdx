...
2. Pick **TrustGuard** (recommended), **OpenAI Moderation**, **Azure Content Safety**,
...
5. Save. Exercise blocks in the [Playground](/trustgate/console/playground); inspect
   **Security** flags under [Activity](/trustgate/console/activity).
...
`TRUSTGUARD_*` environment. See the [TrustGate integration](/trustguard/integrations/gateway/trustgate).
