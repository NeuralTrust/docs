---
title: "Auth"
description: "Auth credentials authenticate clients as a consumer — API key, OAuth2, IDP JWT, or mTLS. Created per gateway and attached to consumers."
---
...
| **`idp`** | `Authorization: Bearer <jwt>` from your IDP; claims select a [role](/trustgate/concepts/roles) | role_based |
...
For **`idp`** credentials, the validated token's claims are matched against role
[IDP mappings](/trustgate/concepts/roles) to select the consumer's routing — this is how
