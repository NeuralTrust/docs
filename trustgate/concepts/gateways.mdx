---
title: "Gateways"
description: "A gateway is the top-level tenant in TrustGate — created in the console, it owns the registries, consumers, auth, and policies beneath it."
---

<p className="nt-lead">
  A gateway is the top-level isolation boundary. Registries, consumers, auth,
