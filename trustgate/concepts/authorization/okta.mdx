---
title: "Okta"
description: "End-to-end manual for wiring Okta to TrustGate: a custom authorization server and scopes, validating Okta bearer tokens on a application, and OAuth2 login for MCP."
---
...
`Authorization: Bearer <token>`. TrustGate verifies the token; the application's own
...
<Steps>
  ...
  <Step title="Attach it to the application">
    ...
    **Save changes**. Registries and models stay under **Routing**, as for any application.
  </Step>
...
<Steps>
  ...
  <Step title="Create an MCP application and attach the auth">
    ...
    connections; the application's servers stay the registries bound under **Routing**.
  </Step>
