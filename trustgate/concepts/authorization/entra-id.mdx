---
title: "Entra ID"
description: "End-to-end manual for wiring Microsoft Entra ID (Azure AD) to TrustGate: an app registration with an exposed API scope, validating Entra bearer tokens on a application, and OAuth2 login for MCP."
---
