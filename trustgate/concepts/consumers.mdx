...
| `role_based` | **Identity-based** | [Roles](/trustgate/concepts/roles) selected from OIDC/OAuth claims decide registries and models. Attach roles under Routing; manage role definitions under [Identity](/trustgate/concepts/authorization/overview). |
