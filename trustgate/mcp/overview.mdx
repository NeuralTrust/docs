...
| Agent | Page |
|---|---|
| Claude (claude.ai, Desktop, Cowork, Code) | [Claude](/trustgate/integrations/claude) |
| Cursor | [Cursor](/trustgate/integrations/cursor) |
| OpenAI Codex | [Codex](/trustgate/integrations/codex) |
| VS Code / GitHub Copilot | [VS Code](/trustgate/integrations/vscode) |
| Microsoft Copilot Studio | [Copilot Studio](/trustgate/integrations/copilot-studio) |
