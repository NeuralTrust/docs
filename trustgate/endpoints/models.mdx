...
1. If the consumer has an allow-list, those ids are candidates.
...
A listed id sent without a provider prefix resolves by walking the consumer's registries in
