...
- **Agent tooling** — a dedicated [MCP Gateway](/trustgate/mcp/overview) exposes MCP servers
  and tools to agents ([Claude](/trustgate/integrations/claude), [Cursor](/trustgate/integrations/cursor),
  [Codex](/trustgate/integrations/codex), [VS Code](/trustgate/integrations/vscode),
  [Copilot Studio](/trustgate/integrations/copilot-studio)) with OAuth2 support.
