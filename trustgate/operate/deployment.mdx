...
TrustGate is a single static binary plus two datastores. Because the planes are selected
...
Compose files: `docker-compose.yaml` (infra only — Postgres and Redis), plus
