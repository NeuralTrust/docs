...
Providers, routing, and Bedrock / Vertex limits: [Embeddings](/trustgate/routing/embeddings).
...
(policies) — or use the full map below.

<CardGroup cols={2}>
  <Card title="Console map" icon="layout-dashboard" href="/trustgate/console/overview">
    Every Agent Gateway sidebar area.
  </Card>
  <Card title="Playground" icon="message-square" href="/trustgate/console/playground">
    Chat through a consumer with policies enforced.
  </Card>
