...
## API Reference
[Explore the API Documentation](../api-reference/overview.md)
...
**API Key:** You need to set the `x-api-key` header to the API key of your gateway, that you created in the [Step 2](#step-2-create-an-api-key).
