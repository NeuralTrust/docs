---
title: "Fallback"
description: "Retry across registries when an upstream fails — configure the ordered chain and triggers on the application Routing tab."
---

**Fallback** turns a single upstream failure into a retry on the next registry instead of
an error to the client. Configure it per [application](/trustgate/access/applications) on the
