...
Per-IP rate limiting tracks and enforces request limits based on the client’s IP address. This helps mitigate abuse or spam originating from a single IP.
...
Below is an example showing how to enable **per_ip** limits:
