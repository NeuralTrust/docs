...
| `moderation.embedding_config.credentials.header_name`  | string  | Name of the header for authentication.                                     | No       | —       |
| `moderation.embedding_config.credentials.header_value` | string  | Value of the header for authentication.                                    | No       | —       |
...
Or for moderation-based blocking:
...
|---------------|-------------|----------------------------------------------------------------------------------------------------------|
| `error`       | string      | Description of the reason for blocking. Indicates the type (`toxicity`, `jailbreak`, `moderation`) and score. |
...
### Basic Configuration
A simple configuration that enables jailbreak detection with default settings:
...
### Advanced Configuration with Moderation
A more advanced configuration that enables semantic similarity-based content moderation:
