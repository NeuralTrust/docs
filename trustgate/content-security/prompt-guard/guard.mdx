...
| `toxicity.threshold`   | float   | Threshold between `0.0` and `1.0` to flag the input.                     | No       | 0.5     |
...
| `jailbreak.threshold`  | float   | Threshold between `0.0` and `1.0` to flag the input.                     | No       | 0.5     |
