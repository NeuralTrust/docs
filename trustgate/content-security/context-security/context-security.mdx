...
> ℹ️ **Dependency:** This plugin requires at least one of [`neuraltrust_guardrail`](../prompt-guard/guard) [`neuraltrust_moderation`](../moderation/neuraltrust) [`toxicity_neuraltrust`](../toxicity/neuraltrust) plugins enabled in the same rule or plugin chain.
