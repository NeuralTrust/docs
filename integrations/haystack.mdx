...
<Step title="Configure credentials" titleSize="h2" id="2-configure-credentials">
```bash
...
<Step title="Gate text in a pipeline" titleSize="h2" id="3-gate-text-in-a-pipeline">
...
<Step title="Guard chat input and completed replies" titleSize="h2" id="4-guard-chat-input-and-completed-replies">
...
<Step title="Run asynchronously and manage client lifetime" titleSize="h2" id="5-run-asynchronously-and-manage-client-lifetime">
...
<Step title="Verify enforcement" titleSize="h2" id="6-verify-enforcement">
