...
| [Microsoft Copilot Studio](/integrations/copilot-studio) | Threat detection evaluates every tool the agent is about to run, authenticated with an Entra federated credential | An MCP tool pointed at a TrustGate consumer |
