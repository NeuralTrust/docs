...
Run the check at the CDN edge, in front of your own AI endpoints. The worker calls
TrustGuard before your origin sees the request. Catalog group: **WAF**.

| Integration | Runs on |
| --- | --- |
| [Cloudflare](/integrations/cloudflare) | A Cloudflare Worker on your AI routes |
| [AWS CloudFront](/integrations/aws-cloudfront) | Lambda@Edge on viewer request |
| [Fastly Compute](/integrations/fastly) | A Fastly Compute service |
| [Akamai EdgeWorkers](/integrations/akamai) | Akamai EdgeWorkers, `responseProvider` |
