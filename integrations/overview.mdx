...
<img
  src="/images/integrations/edge-request-evaluation.svg"
  alt="A request on a configured AI route reaches an edge function, which sends the request content to TrustGuard, blocks or forwards it based on the verdict, and returns the origin response without output inspection."
/>
