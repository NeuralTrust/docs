...
<Step title="Configure credentials and tracing" titleSize="h2" id="2-configure-credentials-and-tracing">
...
<Step title="Create a guarded agent" titleSize="h2" id="3-create-a-guarded-agent">
...
<Step title="Handle decisions" titleSize="h2" id="4-handle-decisions">
