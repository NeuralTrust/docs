...
| **[TrustGate](/trustgate/overview)** | Governs the traffic itself: which providers and models a [application](/trustgate/access/applications) may reach, request rate limits, token and dollar budgets, request-size guards, tool allow-listing, and which MCP tools exist at all | Which models · which tools · spend ceilings |
