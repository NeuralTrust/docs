...
<Step title="Implement the webhook adapter" titleSize="h2" id="1-implement-the-webhook-adapter">
...
<Step title="Configure the BYOG hooks" titleSize="h2" id="2-configure-the-byog-hooks">
...
<Step title="Group the turns of a conversation" titleSize="h2" id="3-group-the-turns-of-a-conversation">
...
<Step title="Configure failure behavior" titleSize="h2" id="4-configure-failure-behavior">
