...
AI-enabled SaaS applications observed across the organization (e.g. ChatGPT Enterprise, Claude.ai, Copilot for Microsoft 365). Tracked at the tenant level, not per-user.

**Populated by:** Cross-correlation of Endpoint Discovery results with the Microsoft Graph and other SaaS APIs you connect.
