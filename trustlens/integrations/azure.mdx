---
title: Azure
description: Azure AI Foundry (v2), AI Hub (classic Foundry), Azure OpenAI Classic (v1), and legacy ML Workspaces — all under one integration.
---
  ...
  <Step title="Create a service principal">
    <Tabs>
      ...
      <Tab title="Azure Portal">
        ...
        2. Name the app (e.g., `neuraltrust-trustlens`)
