...
**Agent-SPM by TrustLens** (TrustLens for short) connects to your cloud accounts, source code, MDM, and SaaS to **discover what AI you have, where it lives, and how exposed it is**. It produces a unified, continuously refreshed inventory and a per-resource posture score so you can prioritize the riskiest surfaces first.
...
<CardGroup cols={2}>
  ...
  <Card title="Pair with Runtime" icon="shield-check" href="/trustgate/platform/index">
    Use Agent-SPM findings as the input to Runtime enforcement policies.
  </Card>
</CardGroup>
