...
4. **Configure enforcement.** Once approved, register the SaaS in the policy. If blocked, configure the [TrustGate Runtime browser extension](/trustgate/platform/enforcement/browser) to enforce the block on managed browsers.
...
TrustLens alerts trigger on **posture** changes — what a resource looks like at rest. [TrustGate Runtime alerts](/trustgate/platform/alerts) trigger on **traffic** anomalies — what a resource does in flight.
