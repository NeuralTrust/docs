---
title: "Evaluate API"
description: "Request and response reference for POST /v1/evaluate, including authentication, attachments, SSRF protections, and status codes"
hidePagination: true
---
...
[How it works](/trustguard/how-it-works) for the evaluation pipeline. Claude
Enterprise uses the specialized endpoint documented in its
