...
decides what to do with `status`. This page covers only the LiteLLM connection. Other gateways: [TrustGate](/trustguard/integrations/trustgate), [Portkey](/trustguard/integrations/portkey), [Kong](/trustguard/integrations/kong), [Apigee](/trustguard/integrations/apigee), [Azure APIM](/trustguard/integrations/azure-apim).
...
[Python SDK](/trustguard/integrations/python-sdk). It adds a dependency to the
