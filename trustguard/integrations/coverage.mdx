...
| --- | --- | --- | --- | --- |
| Gateway | [TrustGate](/trustguard/integrations/gateway/trustgate) | Your gateway (self-hosted or SaaS) | LLM and MCP traffic on guarded routes | Platform team, in the gateway |
| Gateway | [Portkey](/trustguard/integrations/gateway/portkey), [LiteLLM](/trustguard/integrations/gateway/litellm), [Kong](/trustguard/integrations/gateway/kong), [Apigee](/trustguard/integrations/gateway/apigee), [Azure APIM](/trustguard/integrations/gateway/azure-apim) | Gateway infrastructure | LLM API traffic | Platform team, in the gateway config |
| IDE & coding agents | [Claude Enterprise](/trustguard/integrations/ide/claude-enterprise) | Anthropic, server-side | Every model request from Claude chat, Claude Code and Cowork | Anthropic org admin (`organization:manage`) |
| IDE & coding agents | [Claude Code](/trustguard/integrations/ide/claude-code), [Cursor](/trustguard/integrations/ide/cursor), [Codex](/trustguard/integrations/ide/codex), [GitHub Copilot](/trustguard/integrations/ide/copilot) | Developer machines | Prompts, tool calls and tool results | IT, by MDM — developers need no NeuralTrust account |
| Application | [Python](/trustguard/integrations/application/python-sdk), [Node](/trustguard/integrations/application/node-sdk), [REST](/trustguard/integrations/application/rest) | Your code | Any model provider your code calls | Application developers |
| Application | [Python middleware](/trustguard/integrations/application/python-middleware), [Node middleware](/trustguard/integrations/application/node-middleware) | Your service | Every AI route it wraps | Application developers |
| Edge / WAF | [Cloudflare](/trustguard/integrations/edge-waf/cloudflare), [CloudFront](/trustguard/integrations/edge-waf/aws-cloudfront), [Fastly](/trustguard/integrations/edge-waf/fastly), [Akamai](/trustguard/integrations/edge-waf/akamai) | CDN edge | Requests to your own AI endpoints | Platform team, in the CDN |
...
| If you need | Use |
| --- | --- |
| Masking sensitive data in flight | [TrustGate](/trustguard/integrations/gateway/trustgate) — the only collector that rewrites payloads |
| Coverage of streaming completions | [TrustGate](/trustguard/integrations/gateway/trustgate) |
| Org-wide Claude coverage nobody can disable | [Claude Enterprise](/trustguard/integrations/ide/claude-enterprise) |
| Stopping a specific shell command or MCP call | [Claude Code](/trustguard/integrations/ide/claude-code), [Cursor](/trustguard/integrations/ide/cursor), [Codex](/trustguard/integrations/ide/codex), [Copilot](/trustguard/integrations/ide/copilot) |
| A policy decision that needs application context | [Application](/trustguard/integrations/application/python-sdk) collectors |
| Coverage without touching application code | A [gateway](/trustguard/integrations/gateway/trustgate) or [edge](/trustguard/integrations/edge-waf/cloudflare) collector |
