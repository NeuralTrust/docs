...
The four groups and twenty collector types below are exactly what the catalog offers,
...
collector and its key — there is no LangChain or n8n entry in the catalog. And
[Copilot Studio](/integrations/copilot-studio) reaches NeuralTrust through
[TrustGate MCP](/trustgate/mcp/overview), not through a TrustGuard collector at all.
