...
|---|---|
| **AI gateways** | [TrustGate](/integrations/trustgate) (native; no `tgk_…` key), Portkey, LiteLLM, Kong, Apigee, Azure APIM |
| **AI coding agents** | [Claude Code](/integrations/claude-code), [Cursor](/integrations/cursor), [Codex](/integrations/codex), [GitHub Copilot](/integrations/github-copilot) |
| **Agent platforms** | [Claude Enterprise](/integrations/claude-enterprise) |
...
|---|---|---|---|
| [Claude Enterprise](/integrations/claude-enterprise) | Anthropic organization, server-side (`/v1/evaluate/claude`) | `claude-ai`, `claude-code` | Allow or deny only. Ask is treated as Allow because this endpoint has no interactive confirmation. |
...
[How it works](/trustguard/how-it-works). A successful evaluation returns `HTTP 200`
