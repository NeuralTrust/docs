...
The four groups and nineteen collector types below are exactly what the catalog offers,
...
| **AI assistants & coding agents** | [Inference Hooks](/integrations/claude-enterprise) (Claude chat, Claude Code and Cowork, server-side), [Claude Code](/integrations/claude-code), [Cursor](/integrations/cursor), [Codex](/integrations/codex) |
...
| **WAF** | [Cloudflare](/integrations/cloudflare), [AWS CloudFront](/integrations/aws-cloudfront), [Fastly Compute](/integrations/fastly), [Akamai EdgeWorkers](/integrations/akamai) |
...
**Some integrations are not collector types.** [LangChain](/integrations/langchain) and
[n8n](/integrations/n8n) run inside your own process, so they use an **Application**
collector and its key — there is no LangChain or n8n entry in the catalog.
[GitHub Copilot](/integrations/github-copilot) has no catalog entry yet either; ask
NeuralTrust to enable a collector for it. [Copilot Studio](/integrations/copilot-studio)
reaches NeuralTrust through [TrustGate MCP](/trustgate/mcp/overview), not through a
TrustGuard collector at all.
