...
<CardGroup cols={2}>
  ...
  <Card title="Secrets & injections" icon="code">
    Catch leaked credentials in prompts and outputs, and (when enabled) dangerous
    code-injection patterns in request bodies.
  </Card>
</CardGroup>
