...
2. Create detectors from the [catalog](/trustguard/detectors/overview) (DLP + content security as needed).
3. Create a [policy](/trustguard/concepts/policies) with **Input** and **Output** rules.
4. Attach the policy to the collector (default and/or per-consumer).
5. Integrate ([TrustGate](/trustgate/overview), [SDK/REST](/trustguard/integrations/application), or another collector).
