...
The catalog offers **nineteen collector types in four groups**. The group decides where
...
| **AI assistants & coding agents** | The Anthropic organization server-side, or developer machines | Prompts and agent actions, including shell commands, patches, and MCP calls | 4 |
| **Application** | Your own code, around model calls or on the request path | Whatever you pass it | 5 |
| **WAF** | The CDN edge, in front of your application | Inbound requests to your own AI endpoints | 4 |
...
<Note>
**Not every integration is a collector type.**
[LangChain](/integrations/langchain) and [n8n](/integrations/n8n) run inside your own
process and use an **Application** collector — the catalog has no entry for either.
[Copilot Studio](/integrations/copilot-studio) connects through
[TrustGate MCP](/trustgate/mcp/overview) rather than a collector. And
[GitHub Copilot](/integrations/github-copilot) has no catalog entry yet; ask NeuralTrust
to enable a collector for your workspace.
</Note>
