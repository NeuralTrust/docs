...
The integration determines the setup snippet you get and where enforcement
happens. These guides are grouped by where the integration runs.

| Category | Where it runs | What it can see |
|---|---|---|
| **AI gateways** | The AI gateway path | Every LLM and MCP request the gateway proxies |
| **Agent frameworks** | Inside your agent loop or workflow | Prompts, responses, and tool calls in the graph |
| **AI coding agents** | Developer machines | Prompts and agent actions, including shell commands, patches, and MCP calls |
| **Agent platforms** | Organization-managed AI services | Model requests sent through the platform's inference hook |
...
[How it works](/trustguard/how-it-works) to compare enforcement capabilities.
