...
The catalog offers **twenty collector types in four groups**. The group decides where
...
And [Copilot Studio](/integrations/copilot-studio) connects through
[TrustGate MCP](/trustgate/mcp/overview) rather than a collector.
</Note>
