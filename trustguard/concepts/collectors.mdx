...
The **Inference Hooks** collector (Claude chat and Claude Cowork, listed under
Agent platforms) uses `/v1/evaluate/claude`. The Claude Code, Cursor, Codex, and
GitHub Copilot plugins use `/v1/evaluate` with a `tgk_…` key.
