...
matching `direction` on `/v1/evaluate` — [TrustGate](/trustguard/integrations/trustgate)
sets it automatically; [application SDKs](/trustguard/integrations/python-sdk) and
