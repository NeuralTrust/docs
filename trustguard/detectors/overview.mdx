...
| `prompt_moderation_v2` (**Custom Moderation**) · *beta* | Content matching topics you define yourself — name, definition, examples — via the NeuralTrust Firewall topic guard. | input, output | all | — |
