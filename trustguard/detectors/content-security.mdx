...
<Note>
The console **Sensitivity** control (1–4, default 2) and the API `jailbreak.threshold` tune the same Prompt Guard sensitivity. Prefer the console when configuring from the UI; use `threshold` in API/automation.
</Note>
