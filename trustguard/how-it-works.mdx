...
[TrustGate](/trustguard/integrations/gateway/trustgate) sets it from the request/response
stage; [application SDKs](/trustguard/integrations/application/python-sdk) and other collectors
