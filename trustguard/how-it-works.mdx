...
[TrustGate](/trustguard/integrations/trustgate) sets it from the request/response
stage; [application SDKs](/trustguard/integrations/python-sdk) and other collectors
