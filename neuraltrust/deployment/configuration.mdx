...
|---|---|---|
| ClickHouse | `clickhouse` *(fixed by `fullnameOverride`)* | `infrastructure.clickhouse.external.host` |
...
- [Feature flags reference](./feature-flags) — every toggle that changes what gets deployed (PG/Redis/Kafka/CH/registry/storage/secrets)
