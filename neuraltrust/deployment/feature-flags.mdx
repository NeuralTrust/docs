...
| `firewall.enabled` / `firewall.firewall.enabled` / `trustguard.firewall.enabled` | Leave at defaults | Firewall is deployed with TrustGuard. Change these three together or not at all. |
