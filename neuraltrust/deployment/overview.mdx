...
description: Compare SaaS, Hybrid, External, and Central control plane deployment models.
---

<p className="nt-lead">
  Choose the model before you install. It decides which components you run,
  which prerequisites you need, and whether the NeuralTrust console is in the
  path.
</p>
...
<CardGroup cols={2}>
  ...
  <Card title="External" icon="server" href="/neuraltrust/deployment/external">
    You run everything, including the console and analytics.
  </Card>
  <Card title="Central control plane" icon="network" href="/neuraltrust/deployment/central">
    One control plane, data planes in other clusters.
  </Card>
  <Card title="TrustGate install" icon="door-open" href="/trustgate/getting-started/install">
    SaaS vs Private data plane from the product side.
  </Card>
</CardGroup>
...
<Card title="Hybrid" icon="cloud-upload" href="/neuraltrust/deployment/hybrid">
  Architecture, network rules, install, and verification.
</Card>
...
<Card title="External (self-hosted)" icon="server" href="/neuraltrust/deployment/external">
  The full inventory, datastores, and install.
</Card>
...
<Card title="Central control plane" icon="network" href="/neuraltrust/deployment/central">
  The central cluster, cross-cluster endpoints, and remote data planes.
</Card>
...
<CardGroup cols={2}>
  <Card title="High availability" icon="layers" href="/neuraltrust/deployment/high-availability">
    The availability ladder, the two invariants, and the promotion runbook.
  </Card>
