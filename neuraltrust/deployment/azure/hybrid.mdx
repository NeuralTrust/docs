...
Bring your own Postgres (which holds TrustGate admin metadata **and** the raw prompt/response store) — for example Azure Database for PostgreSQL Flexible Server. Azure Cache for Redis can back the in-cluster Redis:
