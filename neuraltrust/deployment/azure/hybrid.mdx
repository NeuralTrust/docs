...
This guide walks you end-to-end through a **hybrid deployment** on AKS — the Data Plane, TrustGate, and (optionally) Firewall run in your cluster; the Control Plane UI, API, and Scheduler run on NeuralTrust SaaS.
