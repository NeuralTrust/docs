...
This guide walks you end-to-end through a **hybrid deployment** on OpenShift — the Data Plane, TrustGate, and (optionally) Firewall run in your OpenShift cluster; the Control Plane UI, API, and Scheduler run on NeuralTrust SaaS.
