...
See [High availability](/neuraltrust/deployment/high-availability) for the
tiers and the promotion runbook, and each model page for what is specific to
[Hybrid](/neuraltrust/deployment/hybrid#high-availability),
